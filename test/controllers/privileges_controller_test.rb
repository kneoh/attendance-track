...
class PrivilegesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create privilege" do
    assert_difference('Privilege.count') do
      post privileges_url, params: { privilege: { description: @privilege.description, title: @privilege.title } }
    end
  ...
  test "should update privilege" do
    patch privilege_url(@privilege), params: { privilege: { description: @privilege.description, title: @privilege.title } }

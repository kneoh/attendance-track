...
class TrainersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create trainer" do
    assert_difference('Trainer.count') do
      post trainers_url, params: { trainer: { category: @trainer.category, user_id: @trainer.user_id } }
    end
  ...
  test "should update trainer" do
    patch trainer_url(@trainer), params: { trainer: { category: @trainer.category, user_id: @trainer.user_id } }
